...
function useOnProgressChange(opts) {
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => offsetX.value, _value => {
    ...
    if (onProgressChange) {
      if (typeof onProgressChange === "function") (0, _reactNativeReanimated.runOnJS)(onProgressChange)(value, absoluteProgress);else onProgressChange.value = absoluteProgress;
    }
